...
def bayes(ngram, essay, classifier):
    '''0 = unigram
       ...
       2 = trigram
    '''
    temp_featuresets = [(document_features(t), "white" if "white" in class_dic[classifier] else "other") for (t, class_dic) in ngram_tuple[ngram][essay] if (t and class_dic[classifier] != False and type(class_dic[classifier]) != float)]
