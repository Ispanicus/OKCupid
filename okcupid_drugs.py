...
def bayes(ngram, essay, classifier):
    '''0 = unigram
       ...
       2 = trigram
    '''
    temp_featuresets = [(document_features(t), "no" if class_dic[classifier] == "never" else "yes") for (t, class_dic) in ngram_tuple[ngram][essay] if (t and class_dic[classifier] != False)]
